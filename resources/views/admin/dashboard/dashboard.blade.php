...
<body class="">
      ...
      <div class="content">
        <div class="row">
            <div class="col-lg-4">
              <div class="card card-chart">
                <div class="card-header">
                  <h5 class="card-category">Statistiques des réservations de terrain</h5>
                  <h4 class="card-title">Statistiques sur les terrains</h4>
                </div>
                <div class="card-body">
                  <div class="chart-area">
                    <canvas id="lineChartTerain"></canvas>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4">
              <div class="card card-chart">
                <div class="card-header">
                  <h5 class="card-category">Statistiques des réservations de salle</h5>
                  <h4 class="card-title">Statistiques sur les salles</h4>
                </div>
                <div class="card-body">
                  <div class="chart-area">
                    <canvas id="lineChartSalle"></canvas>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4">
              <div class="card card-chart">
                <div class="card-header">
                  <h5 class="card-category">Statistiques des réservations de matériel</h5>
                  <h4 class="card-title">Statistiques sur les matériels</h4>
                </div>
                <div class="card-body">
                  <div class="chart-area">
                    <canvas id="lineChartMateriel"></canvas>
                  </div>
                </div>
              </div>
            </div>
  ...
  <script>
    var urlTogetAllReservation = '{{ URL::to('get_chart_global_data') }}';
    var urlTogetTerainReservation = '{{ URL::to('get_chart_terain_data') }}';
    var urlTogetSalleReservation = '{{ URL::to('get_chart_salle_data') }}';
    var urlTogetMaterielReservation = '{{ URL::to('get_chart_materiel_data') }}';
  </script>
