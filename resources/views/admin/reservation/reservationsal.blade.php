    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <h6 id="telephon"></h6>
            <label for="">Salle reservé</label><br>
            <h6 id="salle" style="display: inline-block; margin: 0;"></h6>
            <br>
...
<script>
  ...
  function retrieveDemandes(){
    $.ajax({
      type : 'get',
      url : '{{ URL::to('demandes_reserv_salle') }}',
  ...
  function retrieveDemandesAfterClick(resId,mode){
    $.ajax({
      type : 'get',
      url : '{{ URL::to('demandes_reserv_salle_after') }}',
